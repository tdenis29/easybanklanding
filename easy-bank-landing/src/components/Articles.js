            ...
            <div className="articles-container">
                <div className="article">
                    ...
                    <div className="article-body">
                        ...
                        <p className="article-title">Recieve money in any currency with no fees.</p>
                ...
                <div className="article">
                    ...
                    <div className="article-body">
                        <p className="article-author">By Wilson Hutton</p>
                        <p className="article-title">Treat yourself without worrying about money.</p>
                 ...
                 <div className="article">
                    ...
                    <div className="article-body">
                        <p className="article-author">By Wilson Hutton</p>
                        <p className="article-title">Take your Easybank Card wherever you go!</p>
                ...
                <div className="article">
                    ...
                    <div className="article-body">
                        ...
                        <p className="article-title">Our invite only Beta Accounts are now live!</p>
